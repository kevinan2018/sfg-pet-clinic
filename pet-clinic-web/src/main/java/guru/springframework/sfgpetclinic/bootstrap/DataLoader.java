...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        mikesPet.setBirthDate(LocalDate.of(2018, 01, 12));
        ...
        owner2.setAddress("316 Kirkland Street");
        owner2.setCity("Canonsburg");
        owner2.setTelephone("3213214321");

        Pet fionasCat = new Pet();
        fionasCat.setPetType(savedPetCatType);
        fionasCat.setName("Amiliy");
        fionasCat.setBirthDate(LocalDate.of(2017, 12, 23));
